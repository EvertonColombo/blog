...
<div class="slide-grid">
  ...
  <a href="ai-assets/slides/16.jpg" class="slide-item" onclick="openLightbox(event, this.href)">
    <img src="ai-assets/slides/16.jpg" loading="lazy">
    <span class="slide-number">16</span>
  </a>
  <a href="ai-assets/slides/17.jpg" class="slide-item" onclick="openLightbox(event, this.href)">
    <img src="ai-assets/slides/17.jpg" loading="lazy">
    <span class="slide-number">17</span>
  </a>
  <a href="ai-assets/slides/18.jpg" class="slide-item" onclick="openLightbox(event, this.href)">
    <img src="ai-assets/slides/18.jpg" loading="lazy">
    <span class="slide-number">18</span>
  </a>
  <a href="ai-assets/slides/19.jpg" class="slide-item" onclick="openLightbox(event, this.href)">
    <img src="ai-assets/slides/19.jpg" loading="lazy">
    <span class="slide-number">19</span>
  </a>
  <a href="ai-assets/slides/20.jpg" class="slide-item" onclick="openLightbox(event, this.href)">
    <img src="ai-assets/slides/20.jpg" loading="lazy">
